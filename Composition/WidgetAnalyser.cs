...
namespace Composition
{
    ...
    /// <summary>
    /// Action Bar Text Class
    /// Used to model the text found in an action bar
    /// </summary>
    public class ActionBarText
    {
        // This class was intended to be used for not only action bar titles, but for textual buttons too.
