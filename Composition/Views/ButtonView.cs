...
namespace Composition.Views
{
    ...
    public class ButtonView : View
    {
        ...
        public void RegisterButtonTextWithStringsClass(Design design)
        {
            ButtonTextStringID = Strings.AddString(design.ActivityName, ButtonText, this.WidgetType);
        }
